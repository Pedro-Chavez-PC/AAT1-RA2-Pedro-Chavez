...
public class ModificarSucursal extends javax.swing.JFrame {
    ...
    static LinkedList<Sucursales> lista_sucursales;
    private int id;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(cancelar, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE))
        );
    ...
    public void modificar (int id) {
        Sucursales modificar = Sucursales.lista_sucursales.get(id);
        modificar.setNombre(nom.getText());
        modificar.setDireccion(dir.getText());
        modificar.setCorreo(cor.getText());
        modificar.setTelefono(Integer.parseInt(tel.getText()));
    }
    
    public void mostrar (int id){
        this.id = id;
        cod.setText(Sucursales.lista_sucursales.get(id).getCodigo()+"");
        nom.setText(Sucursales.lista_sucursales.get(id).getNombre()+"");
        dir.setText(Sucursales.lista_sucursales.get(id).getDireccion()+"");
        cor.setText(Sucursales.lista_sucursales.get(id).getCorreo()+"");
        tel.setText(Sucursales.lista_sucursales.get(id).getTelefono()+"");
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarSucursal().setVisible(true);
            }
        });
    }
