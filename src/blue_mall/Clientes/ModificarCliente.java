...
public class ModificarCliente extends javax.swing.JFrame {
    ...
    static LinkedList<Clientes> lista_clientes;
    private int id;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(cancelar, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE))
        );
    ...
    private void btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActionPerformed
        if (cod.getText().equals("") || nom.getText().equals("") || nit.getText().equals("") || cor.getText().equals("") || gen.getText().equals("")){
    ...
    public void modificar (int id) {
        Clientes modificar = Clientes.lista_clientes.get(id);
        modificar.setNombre(nom.getText());
        modificar.setNit(Integer.parseInt(nit.getText()));
        modificar.setCorreo(cor.getText());
        modificar.setGenero(gen.getText());
    }
    
    public void mostrar (int id){
        this.id = id;
        cod.setText(Clientes.lista_clientes.get(id).getCodigo()+"");
        nom.setText(Clientes.lista_clientes.get(id).getNombre()+"");
        nit.setText(Clientes.lista_clientes.get(id).getNit()+"");
        cor.setText(Clientes.lista_clientes.get(id).getCorreo()+"");
        gen.setText(Clientes.lista_clientes.get(id).getGenero()+"");
    }
